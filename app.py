...
def transform_dataframe(df):
    """
    Args:
        df (_type_): raw pandas dataframe
    Returns:
...
if selected_dropdown == 'Caloric Model':
    dropdown_c_options = ['VeryActiveMinutes', 'LightlyActiveMinutes', 
                          'SedentaryMinutes', 'ModeratelyActiveDistance', 'VeryActiveDistance', 'SedentaryActiveDistance']
    selected_c_dropdown = st.selectbox("Select Variable", 
                                       options = dropdown_c_options)
