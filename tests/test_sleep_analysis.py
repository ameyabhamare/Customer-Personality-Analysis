"""
Unit test for sleep analysis module
"""
import sys
import os
import unittest
...
class TestProcessDailySleepData(unittest.TestCase):
    ...
    def test_process_sleep_analysis_smoke(self):
        ...
        smoke test
        """
        df_result = analysis.sleep_analysis.process_sleep_analysis_data(
            self.df, '1503960366')
    ...
    def test_process_sleep_analysis_data(self):
        filtered_data = analysis.sleep_analysis.process_sleep_analysis_data(
            self.df, user_id='1503960366')
        expected_columns = ['Id', 'TotalMinutesAsleep',
