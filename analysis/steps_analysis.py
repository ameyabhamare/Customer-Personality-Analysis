"""
Process daily steps and sleep data and generate graphs.
"""
import pandas as pd
...
def process_daily_sleep_steps_data(df_daily_steps, df_daily_sleep, user_id='1503960366'):
    ...
    df_sleep_proc = sleep_analysis.process_sleep_analysis_data(
        df_daily_sleep, user_id=user_id)

    # merge both data set (inner join) with sleep data
    df_merged = pd.merge(df_daily_steps, df_sleep_proc,
                         how='inner', left_on='ActivityDay', right_on='SleepDate')
